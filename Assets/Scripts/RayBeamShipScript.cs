...
public class RayBeamShipScript : MonoBehaviour
{
    ...
    IEnumerator EnemyShoot()
    {
        ...
        Instantiate(enemyProjectile, new Vector2(transform.position.x, transform.position.y-8.6f), Quaternion.identity);
        shootSound.Play();
    }
